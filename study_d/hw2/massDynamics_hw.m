classdef massDynamics_hw < handle
    ...
    methods
        %---constructor-------------------------
        function self = massDynamics_hw(P)
            ...
            self.k = P.k * (1+2*alpha*rand-alpha);  % Length of the arm, m
        ...
        function xdot = f(self, state, u)
            ...
            zddot = (F - self.b*zdot - self.k*z)*(1/self.m);
