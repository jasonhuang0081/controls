classdef massControllerHW07 < handle
    %----------------------------
    properties
        z_dot
        z_d1
    ...
    methods
        %----------------------------
        function self = massControllerHW07(P)
        ...
        function force = update(self, z_r, y)
            ...
            % Construct the state - in future problems, we won't have
            % access to self.z_dot in this same way, we'll use observers
            % instead
            x = [z; self.z_dot];
