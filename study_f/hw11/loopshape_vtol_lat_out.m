...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        gamma_n = 10^(-5);   % attenuate noise by this amount
        add_spec_noise(gamma_n, omega_n, flag_abs);
        

  figure(7), bode(Plant,logspace(-3,5), options), grid on
...
% phase lead: increase PM (stability)
    ...
    M    = 100; % separation between zero and pole
...
[P.num_Clat_out, P.den_Clat_out] = tfdata(C,'v');
[P.num_Flat, P.den_Flat] = tfdata(F,'v');
